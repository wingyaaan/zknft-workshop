export const NFTProgramId = 'privacy_pride_nft_alvinyap510.aleo';

export const NFTProgram = `program privacy_pride_nft_alvinyap510.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo19ft60nf3n7pke26teahksrlg50rjz7ukwu9hew5myf9ggtqcggqsnzmh4d;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as privacy_pride_nft_alvinyap510.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as privacy_pride_nft_alvinyap510.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as privacy_pride_nft_alvinyap510.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as privacy_pride_nft_alvinyap510.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as privacy_pride_nft_alvinyap510.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as privacy_pride_nft_alvinyap510.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as privacy_pride_nft_alvinyap510.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as privacy_pride_nft_alvinyap510.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as privacy_pride_nft_alvinyap510.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as privacy_pride_nft_alvinyap510.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as privacy_pride_nft_alvinyap510.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as privacy_pride_nft_alvinyap510.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as privacy_pride_nft_alvinyap510.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as privacy_pride_nft_alvinyap510.aleo/convert_public_to_private.future;
